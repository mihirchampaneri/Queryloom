...
module.exports = {
  async up (queryInterface, Sequelize) {
    await queryInterface.bulkInsert('Countries', [
      ...
      { id: 234, name: 'Vanuatu' },
      { id: 235, name: 'Vatican City State (Holy See)' },
      ...
      { id: 245, name: 'Åland Islands' },
      { id: 246, name: 'Kosovo' },
      { id: 247, name: 'Curacao' },
      { id: 248, name: 'Bonaire, Sint Eustatius and Saba' },
      { id: 249, name: 'Sint Maarten (Dutch part)' },
      { id: 250, name: 'Saint Martin (French part)' }
